...
protected:
    ...
    virtual void writeHeader(QTextStream &t);
    ...
    virtual QString filePrefixRoot(const QString &, const QString &);
...
public:
    ...
    virtual bool isDosLikeShell() const { return Option::host_mode == Option::HOST_WIN_MODE ||
