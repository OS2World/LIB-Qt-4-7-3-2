...
win32 {
        ...
        SOURCES += io/qsettings_os2.cpp
        SOURCES += io/qprocess_os2.cpp
        SOURCES += io/qfsfileengine_os2.cpp

        SOURCES += io/qfsfileengine_iterator_os2.cpp
        SOURCES += io/qfilesystemwatcher_os2.cpp
        HEADERS += io/qfilesystemwatcher_os2_p.h
} else:unix {
