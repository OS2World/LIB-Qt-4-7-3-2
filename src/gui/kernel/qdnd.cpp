                                           ...
                                           Qt::KeyboardModifiers modifiers) const
{
    ...
    qDebug("keyboard modifiers : %ls", KeyboardModifiersToString(modifiers).utf16());
#endif
...
#ifdef QDND_DEBUG
    qDebug("possible actions : %ls", dragActionsToString(possibleActions).utf16());
#endif
...
#ifdef QDND_DEBUG
    qDebug("default action : %ls", dragActionsToString(defaultAction).utf16());
#endif
