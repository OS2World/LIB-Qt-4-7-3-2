...
/*!
    ...
    be a pipe path such as "\\\\.\\pipe\\foo". On OS/2, "\\socket\\" is
    automatically prepended to the name if it does not already sttart with
    this prefix.
...
/*!
    ...
    On Windows and OS/2, this function does nothing; on Unix, it removes the
    socket file given by \a name.
