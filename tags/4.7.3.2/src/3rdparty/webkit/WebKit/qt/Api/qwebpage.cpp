...
#elifif defined Q_OS_OS2
        switch (QSysInfo::os2Version()) {
        default:
        case QSysInfo::OV_Unknown:
            firstPartTemp += QLatin1String("Unknown"); break;
        case QSysInfo::OV_2_0:
            firstPartTemp += QLatin1String("2.0"); break;
        case QSysInfo::OV_2_1:
            firstPartTemp += QLatin1String("2.1"); break;
        case QSysInfo::OV_2_11:
            firstPartTemp += QLatin1String("2.11"); break;
        case QSysInfo::OV_3_0:
            firstPartTemp += QLatin1String("Warp 3"); break;
        case QSysInfo::OV_4_0:
            firstPartTemp += QLatin1String("Warp 4"); break;
        case QSysInfo::OV_4_5:
            firstPartTemp += QLatin1String("Warp 4.5"); break;
        case QSysInfo::OV_4_52:
            firstPartTemp += QLatin1String("Warp 4.52"); break;
        case QSysInfo::OV_ECS_Unknown:
            firstPartTemp += QLatin1String("eCS"); break;
        case QSysInfo::OV_ECS_1_0:
            firstPartTemp += QLatin1String("eCS 1.0"); break;
        case QSysInfo::OV_ECS_1_1:
            firstPartTemp += QLatin1String("eCS 1.1"); break;
        case QSysInfo::OV_ECS_1_2:
            firstPartTemp += QLatin1String("eCS 1.2"); break;
        case QSysInfo::OV_ECS_2_0:
            firstPartTemp += QLatin1String("eCS 2.0"); break;
        }
