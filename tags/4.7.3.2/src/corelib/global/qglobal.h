...
#  if defined(Q_OS_WIN) || defined(Q_OS_OS2) || defined(Q_CC_NOKIAX86) || defined(Q_CC_RVCT)
#    define Q_DECL_EXPORT __declspec(dllexport)
...
/*
   Create Qt DLL if QT_DLL is defined (Windows, Symbian and OS/2 only)
*/
...
#    endif
#elif defined(Q_OS_OS2) && defined(Q_CC_GNU)
// the dllexport attribute effectively cancels inlining even when it is possible
// (e.g. in optimized builds) so omit it to have such functions actually inlined
#    define Q_CORE_EXPORT_INLINE inline
#    define Q_GUI_EXPORT_INLINE inline
...
*/
#if defined(QT_BUILD_INTERNAL) && (defined(Q_OS_WIN) || defined(Q_OS_SYMBIAN) || defined(Q_OS_OS2)) && defined(QT_MAKEDLL)
#    define Q_AUTOTEST_EXPORT Q_DECL_EXPORT
#elif defined(QT_BUILD_INTERNAL) && (defined(Q_OS_WIN) || defined(Q_OS_SYMBIAN) || defined(Q_OS_OS2)) && defined(QT_DLL)
#    define Q_AUTOTEST_EXPORT Q_DECL_IMPORT
#elif defined(QT_BUILD_INTERNAL) && !(defined(Q_OS_WIN) || defined(Q_OS_SYMBIAN) || defined(Q_OS_OS2)) && defined(QT_SHARED)
#    define Q_AUTOTEST_EXPORT Q_DECL_EXPORT
#else
...
#  error "Qt not configured correctly, please run configure"
    ...
    enum Os2Version {
        ...
        /* eComStation version */
        OV_ECS_Unknown  = 0x06000000,
        OV_ECS_1_0      = 0x06010000,
        OV_ECS_1_1      = 0x06010100,
        OV_ECS_1_2      = 0x06010200,
        OV_ECS_2_0      = 0x06020000,
        OV_ECS_2_1      = 0x06020100,
        OV_ECS_2_2      = 0x06020200,

        /* version masks */
        OV_WARP3        = 0x01000000,
        OV_WARP4        = 0x02000000,
        OV_WARP         = OV_WARP3 | OV_WARP4,
        OV_ECS          = 0x04000000,
    };
    static Os2Version os2Version();
#endif
};
