...
#if (defined (Q_OS_UNIX) && !defined(QTOPIA_PRINTDIALOG) && !defined(Q_WS_MAC) && !defined(Q_OS_SYMBIAN)) || defined (Q_WS_PM)
...
public:
    ...
    int exec();
#if (defined (Q_OS_UNIX) && !defined(QTOPIA_PRINTDIALOG) && !defined(Q_WS_MAC)) || defined (Q_WS_PM)
    virtual void accept();
#endif
...
#if defined(Q_OS_UNIX) || defined(Q_WS_MAC) || defined(Q_OS_WIN) || defined (Q_WS_PM)
...
#if (defined (Q_OS_UNIX) && !defined (Q_OS_MAC)) || defined (Q_WS_PM)
    Q_PRIVATE_SLOT(d_func(), void _q_collapseOrExpandDialog())
#endif
# if ((defined(Q_OS_UNIX) && !defined (Q_OS_MAC)) || defined (Q_WS_PM)) && !defined(QT_NO_MESSAGEBOX)
