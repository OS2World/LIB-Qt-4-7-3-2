...
os2 {
        SOURCES += \
                painting/qcolormap_pm.cpp \
                painting/qpaintdevice_pm.cpp \
                painting/qprinterinfo_pm.cpp
}
...
win32|os2|x11|mac|embedded|symbian {
...
os2 {
        HEADERS += painting/qwindowsurface_pm_p.h
        SOURCES += painting/qwindowsurface_pm.cpp
}
