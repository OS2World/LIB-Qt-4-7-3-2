...
#if defined (Q_WS_X11) || (defined(Q_WS_PM) && !defined(QT_NO_FREETYPE))
...
#if (defined(Q_WS_X11) || defined(Q_WS_QWS) || defined(Q_OS_SYMBIAN) || defined(Q_WS_PM)) && !defined(QT_NO_FREETYPE)
