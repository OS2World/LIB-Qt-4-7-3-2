...
#ifndef QFONTENGINE_PM_P_H
#define QFONTENGINE_PM_P_H
...
class Q_GUI_EXPORT QFontEnginePMFT : public QFontEngineFT
{
public:
    enum HintStyle {
    ...
    explicit QFontEnginePMFT(const QFontDef &fd, const FaceId &faceId,
