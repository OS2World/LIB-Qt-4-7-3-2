...
os2 {
		SOURCES += \
				util/qsystemtrayicon_pm.cpp
		# @todo this should be required to present extenrally in the
		# environment when it gets moved to XWP (see #99 for details)
		INCLUDEPATH += \
				../3rdparty/os2/xsystray/apilib
}
