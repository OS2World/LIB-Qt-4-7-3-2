...
#elif defined(Q_OS_OS2)
        if (type == QLatin1String("os"))
            ret = QString::fromLatin1("OS/2");
        else if (type == QLatin1String("name"))
            ret = QString::fromLocal8Bit(qgetenv("HOSTNAME"));
        // @todo use QSysInfo::OS2Version for version/version_string once it's there
        else if (type == QLatin1String("version"))
            ret = QString::fromLatin1("unknown");
        else if (type == QLatin1String("version_string"))
            ret = QString::fromLatin1("unknown");
        else if (type == QLatin1String("arch"))
            ret = QString::fromLatin1("x86");
